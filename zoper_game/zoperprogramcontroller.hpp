...
public:
    ...
    void onInit(haf::sys::ISystemProvider& system_provider, haf::sys::DataWrapperCreator &data_wrapper_creator) override;
    void onFinish(haf::sys::ISystemProvider& system_provider, haf::sys::DataWrapperCreator &data_wrapper_creator) override;
