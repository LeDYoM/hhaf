...
public:
    ...
    ~TTFont() override;
    mtps::Rectf32 getBounds(const mtps::u32 codePoint,
                            const mtps::u32 characterSize) const override;
    mtps::Rectf32 getTextureBounds(
        const mtps::u32 codePoint,
        const mtps::u32 characterSize) const override;
    mtps::f32 getAdvance(const mtps::u32 codePoint,
                         const mtps::u32 characterSize) const override;
    ...
    mtps::f32 getKerning(const mtps::u32 first,
                         ...
                         const mtps::u32 characterSize) const override;
    mtps::sptr<ITexture> getTexture(
        const mtps::u32 characterSize) const override;
    mtps::vector2df textSize(const mtps::str& text,
                             const mtps::u32 characterSize) const override;
