 ...
 */
class MenuPaged : public SceneNode, public MenuPagedProperties
{
public:
    ...
    using SceneNode::set;
    using SceneNode::put;
    using MenuPagedProperties::readResetHasChanged;
    using MenuPagedProperties::get;
    using MenuPagedProperties::set;
    using MenuPagedProperties::put;
