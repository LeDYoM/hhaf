...
public:
    ...
    void mydraw(const VertexBuffer& vertexBuffer, std::size_t firstVertex,
    ...
    ////////////////////////////////////////////////////////////
    void resetGLStates();
    void mysetupDraw(bool useVertexCache, const RenderStates& states);
    void mycleanupDraw(const RenderStates& states);
